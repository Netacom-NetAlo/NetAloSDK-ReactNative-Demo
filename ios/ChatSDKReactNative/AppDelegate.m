...
- (instancetype)init
{
  self = [super init];
  if (self) {
    NetaloConfigurationObjc *configrn = [[NetaloConfigurationObjc alloc]
                                       initWithEnviroment:2
                                       appId:10
                                       appKey:@"PS2zTS5$VyZccSaj"
                                       accountKey:@"Gb6hC8BxmETdXXM"
                                       appGroupIdentifier: @"group.hura.asia"
                                       storeUrl:@"https://apps.apple.com/vn/app/hura-hd-video-call/id1630020464"
                                       ...
                                       userProfileUrl: @""
                                       allowAddBundleId: NO
                                       deeplinkSchema: @"yourschema"                           
        ];
          
        _sdk = [[NetAloFullManager alloc] initWithConfig:configrn.netaloConfiguration];
  }
